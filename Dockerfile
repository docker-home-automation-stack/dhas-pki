...
COPY ./src/pki/openssl.cnf ./src/pki/vars ./src/pki/x509-types ./src/pki/server-rsa-ca ./src/pki/server-ec-ca ./src/pki/client-rsa-ca ./src/pki/client-ec-ca ${SVC_HOME}/
